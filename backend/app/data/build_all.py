...
Usage:
    python -m app.data.build_all --csv path/to/paysim.csv

Outputs augmented data to app/processed/.
"""
...
DEFAULT_OUTPUT_DIR = Path("app/processed")
...
def build_all(
    ...
    from app.data.paysim_loader import PaySimLoader
    ...
    from app.data.augment_accounts import augment_accounts
