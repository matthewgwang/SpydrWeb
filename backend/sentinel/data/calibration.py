...
class DataCalibrator:
    ...
    def _calibrate_from_ieee(self) -> None:
        ...
        try:
            from sentinel.datasets.ieee_cis import extract_distributions
    ...
    def _calibrate_from_baf(self) -> None:
        ...
        try:
            from sentinel.datasets.feedzai_baf import extract_demographics
    ...
    def _calibrate_from_paysim(self) -> None:
        ...
        try:
            from sentinel.datasets.ieee_cis import extract_timing
