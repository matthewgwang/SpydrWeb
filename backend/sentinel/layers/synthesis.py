...
from sentinel.ai.prompts import SYNTHESIS_PROMPT
from sentinel.models.layers import ExploitationTactic, LayerSignal
from sentinel.models.report import EvidenceBrief, InterventionRecommendation
...
if TYPE_CHECKING:
    ...
    from sentinel.models.layers import TestPlan
